    ...
    public partial class UsersAccountDialog : Form {
            ...
            if (UsernameSwitch == 1 && PasswordSwitch == 0) {
                if (!CheckUsernameControlslIfEmpty() && (Usernames != txtUsername.Text)) {
                    using(MySqlConnection mysqlCon = new MySqlConnection(connectionString)) {
                        ...
                        MessageBox.Show("The username of the account has been updated.", "Updated Account Username", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
                ...
                if (!CheckPasswordControlsIfEmpty()) {
                    ...
                    if (ValidateUserPasswordByID(UserID, OldPassword)) {
                        using (MySqlConnection mysqlCon = new MySqlConnection(connectionString)) {
                            ...
                            MessageBox.Show("The password of the account has been updated.", "Updated Account Password", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        }
                ...
                if (!CheckUsernameControlslIfEmpty() && !CheckPasswordControlsIfEmpty()) {
                    using (MySqlConnection mysqlCon = new MySqlConnection(connectionString)) {
                        if (ValidateUserPasswordByID(UserID, OldPassword)) {
                            ...
                            MessageBox.Show("The account settings has been updated successfully.", "Updated Account Settings", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void ValidateNFillDataControl() {
            ...
            if(result.Rows.Count == 1) {
                ...
                MessageBox.Show("There was a problem in fetching the data for the selected user. Please try again.", "Invalid User Information", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
