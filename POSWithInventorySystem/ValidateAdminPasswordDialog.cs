            ...
            if (e.KeyCode == Keys.Enter)
            {
                ...
                else
                {
                    ...
                    if (ValidateAdminPassword())
                    {
                        ...
                        {
                            //This is UsersForm and Not POSForm, Just Conflict in Visual Studio Renaming, its just an Error but Usable...
                ...
                using (MySqlConnection mysqlCon = new MySqlConnection(connectionString))
                {
                    ...
                    else
                    {
                        if (CallerOfForm == "BackupForm")
                        {
                            ...
                            {
                                MessageBox.Show("Invalid Password", "Incorrect", MessageBoxButtons.OK, MessageBoxIcon.Error);
                            }
                        }
                        else
                        {
